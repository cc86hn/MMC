...
public class MP4Thread implements Runnable,ProcessWatcher
{
    ...
    public void run()
    {
        if(fastmode)
        {
            ...
            Tools.runCmdWithPassthru(IoBuilder.forLogger("External.VNC").buildPrintStream(), this, "ffmpeg","-f","dshow","-framerate","24",
        ...
        {
            Tools.runCmdWithPassthru(IoBuilder.forLogger("External.VNC").buildPrintStream(), this, "ffmpeg","","","","","","","","");
        }
    }
    @Override
